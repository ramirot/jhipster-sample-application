...
class CountryResourceIT {
    ...
    public static Country createEntity(EntityManager em) {
        Country country = new Country().countryName(DEFAULT_COUNTRY_NAME).code(DEFAULT_CODE);
        return country;
    }
    ...
    public static Country createUpdatedEntity(EntityManager em) {
        Country country = new Country().countryName(UPDATED_COUNTRY_NAME).code(UPDATED_CODE);
        return country;
    }
    ...
    void putExistingCountry() throws Exception {
        ...
        updatedCountry.countryName(UPDATED_COUNTRY_NAME).code(UPDATED_CODE);
    ...
    void partialUpdateCountryWithPatch() throws Exception {
        ...
        partialUpdatedCountry.countryName(UPDATED_COUNTRY_NAME).code(UPDATED_CODE);
